...
2. VUE T-x (P2.2) — lisibilité :
    - Badge de fraîcheur sur chaque territoire connu ("T-2" ou "il y a
      2 tours"), territoires inconnus traités selon la vue P2.2, T0 sans badge
      (ou badge "maintenant"). L'âge de l'information est rendu par des pois
      superposés sans modifier la couleur du terrain : taille croissante pour
      T-1 et T-2, taille maximale à T-3 et au-delà, avec une indication que
      l'information est non fiable à partir de trois tours.
