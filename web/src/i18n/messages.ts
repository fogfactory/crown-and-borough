...
const englishMessages = {
  ...
  'orders.deckDescription': 'Play cards independently of noble chains. Use P KIND TER during action seasons.',
  'orders.deckWinterDescription': 'The hand is replenished automatically in winter. Use D C KIND to discard cards before the refill.',
...
const frenchMessages: Record<keyof typeof englishMessages, string> = {
  ...
  'orders.deckDescription': 'Jouez les cartes indépendamment des chaînes de nobles. Utilisez P KIND TER pendant les saisons d’action.',
  'orders.deckWinterDescription': 'La main est reconstituée automatiquement en hiver. Utilisez D C KIND pour défausser des cartes avant la reconstitution.',
