...
| [P1.8](prompts/p1.8-interaction-lisibilite-carte.md) | Interaction & lisibilité de la carte | Clic gauche sélection/désélection, fond SVG désélection, clic gauche maintenu + déplacement pour déplacer, lisérés intérieurs de sélection et de contrôle | Tests/manœuvres manuelles : gestes, frontières et contrôle entre joueurs | Carte : suppression du remplissage de contrôle, lisérés intérieurs avec motifs de frontière cohérents, aides et légende cohérentes | Fait |
| [P1.9](prompts/p1.9-validation-partielle-chaines.md) | Validation partielle des chaînes | Non-adjacence différée à l'exécution ; ordres précédents conservés, ordre fautif et suffixe postérieur brisés | Tests moteur : chaîne O1/O2 valides, O3 non adjacent, erreurs bloquantes inchangées | Réception affichée comme reçue puis brisée, non comme perdue | Fait |
| [P1.10](prompts/p1.10-poste-commandement-rapport.md) | Poste de commandement & rapport lisible | Onglets partagés, nobles présents, pile complète d'ordres, DTO d'ordre complet, codes territoriaux visibles et marqueurs joueur/noble | Tests front/API : onglets, pile, labels complets, résultats et messages sans matricule | Poste de commandement et rapport dans une même zone ; ordre courant distingué ; chaque ordre possède label, noble, couleur et résultat | Fait |
| [P1.11](prompts/p1.11-hiver-signalisation-bilan.md) | Signalisation de l'hiver & bilan des coûts | Thème hivernal distinct, teinte neige de la carte, coût total de chaque ordre d'hiver réussi dans le rapport | Tests moteur/front : coûts simples, multi-sources, gratuits et rejetés ; lisibilité saisonnière | Panneau d'ordres d'hiver et carte immédiatement identifiables | Fait |
| [P1.12](prompts/p1.12-villages-neutres-productifs.md) | Villages neutres productifs | Production et stockage neutres, conservation, capture sans perte du stock et disponibilité au nouveau contrôleur | Tests multi-tours : accumulation, non-disponibilité avant capture, capture, hiver, ravitaillement | Rapport capable de distinguer une source neutre sans propriétaire joueur | Fait |
