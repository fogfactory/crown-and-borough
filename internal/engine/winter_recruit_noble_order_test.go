...
func TestRecruitNobleOrderApply(t *testing.T) {
	...
	state.TerritoryStates["AAA"] = models.TerritoryState{OwnerID: state.TerritoryStates["AAA"].OwnerID, Army: state.TerritoryStates["AAA"].Army, Resources: 2, Infrastructures: infraPointer("I1")}
