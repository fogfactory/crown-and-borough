...
| [P1.8](prompts/p1.8-interaction-lisibilite-carte.md) | Interaction & lisibilité de la carte | Clic gauche sélection/désélection, fond SVG désélection, Ctrl + clic-glisser pour déplacer, lisérés intérieurs de sélection et de contrôle | Tests/manœuvres manuelles : gestes, frontières et contrôle entre joueurs | Carte : suppression du remplissage de contrôle, lisérés intérieurs, aides et légende cohérentes | Prompt écrit |
