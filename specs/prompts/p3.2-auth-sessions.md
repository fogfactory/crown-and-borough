...
3. CONTRÔLE D'ACCÈS (middleware chi) :
   ...
   - GET /api/games/{id}/reports : chaque joueur accède à SA vue du
     rapport (filtrée et différée selon ses sources, cf. P2.2)
...
de slot par nom + code en partie commencée, rapports par joueur filtrés et
différés, pas de déconnexion) pour mise à jour des specs (ne modifie pas les
