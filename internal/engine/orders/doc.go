...
// attaches a valid chain to an army. Static adjacency diagnostics reject a
// chain before reception. Execution-time conditions, simultaneous resolution,
// and chain progression belong to engine.Resolve.
package orders
